...
import vnuk.huong170205.assignment2.controller.PersonFactory;
import vnuk.huong170205.assignment2.controller.Subject;
...
public class Menu {
	...
	public static void menu6() {
		...
		System.out.format("%-4s %-20s %-12s %n", "No.", "Name", "Salary");
		
		Person person;
		
		for (int index =0; index < Define.persons.size(); index ++) {
			person = Define.persons.get(index);
			System.out.format("%-4s %-20s %-12s %n",
					index,
					person.getName(),
					person.getSalary());
		}
	...
	public static void menu7() {
		Scanner sc = new Scanner (System.in);
		System.out.println("Add new minimun wage");
